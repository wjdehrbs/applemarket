...
import com.example.homwark.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        dataList.add(MyItem(R.drawable.sample1, "산지 한달된 선풍기 팝니다", "이사가서 필요가 없어졌어요 급하게 내놓습니다", "대현동", 1000, "서울 서대문구 창천동", 13, 25))
        ...
        ad.show()
         ...
         fun notification() {
            ...
            builder.run {
                ...
                setContentText("설정한 키워드에 대한 알림 도착")
            }
